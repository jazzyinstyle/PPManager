...
namespace PPManager
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // lstList
            // 
            this.lstList.AllowDrop = true;
            this.lstList.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
            ...
            // txtDir
            // 
            this.txtDir.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
            ...
            this.btnDir.Location = new System.Drawing.Point(425, 18);
            ...
            // txtSaveAs
            // 
            this.txtSaveAs.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
            ...
            this.linkLabel1.Location = new System.Drawing.Point(20, 306);
            ...
            this.saveFileDialog.DefaultExt = "ppt";
            // 
            // button1
            // 
		...
		private void ShowPresentation()
		{
            ...
            {
                MessageBox.Show("Please enter a valid location to save the file.");
                return;
            }
			...
			for(int i = 0; i < lstList.Items.Count; i++)
			{
				...
				{
					PowerPoint.Slide slide = objPres.Slides[iCount];
					slide.Design = objPresOpen.Slides[j].Design;
					slide.ColorScheme = objPresOpen.Slides[j].ColorScheme;
